...
func TestContentCommandsGoldenFixtures(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "content get success", arguments: []string{"content", "get", "content-1", "enterprise-1", "--json"}, method: http.MethodGet, path: "/v0/enterprise/enterprise-1/content/content-1/", fixture: "content-get-success.json", golden: "content-get-success.golden", status: http.StatusOK},
		{name: "content delete success", arguments: []string{"content", "delete", "content-1", "enterprise-1", "--yes", "--json"}, method: http.MethodDelete, path: "/v0/enterprise/enterprise-1/content/content-1/", fixture: "content-delete-success.body", golden: "content-delete-success.golden", status: http.StatusNoContent},
		{name: "content patch success", arguments: []string{"content", "patch", "content-1", "enterprise-1", "--description", "Updated fixture", "--json"}, method: http.MethodPatch, path: "/v0/enterprise/enterprise-1/content/content-1/", body: `{"description":"Updated fixture"}`, fixture: "content-patch-success.json", golden: "content-patch-success.golden", status: http.StatusOK},
...
func TestContentCommandsAPIErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "content get API error", arguments: []string{"content", "get", "content-1", "enterprise-1", "--json"}, method: http.MethodGet, path: "/v0/enterprise/enterprise-1/content/content-1/", fixture: "content-get-api-error.json"},
		{name: "content delete API error", arguments: []string{"content", "delete", "content-1", "enterprise-1", "--yes", "--json"}, method: http.MethodDelete, path: "/v0/enterprise/enterprise-1/content/content-1/", fixture: "content-delete-api-error.json"},
		{name: "content patch API error", arguments: []string{"content", "patch", "content-1", "enterprise-1", "--description", "Updated fixture", "--json"}, method: http.MethodPatch, path: "/v0/enterprise/enterprise-1/content/content-1/", body: `{"description":"Updated fixture"}`, fixture: "content-patch-api-error.json"},
...
func TestContentCommandInputValidation(t *testing.T) {
	tests := []struct {
		...
		{name: "content patch body cannot combine property flags", arguments: []string{"content", "patch", "content-1", "enterprise-1", "--body", `{}`, "--description", "Updated fixture"}},
	}
